...
|------|--------|-----------|
| CSP de ambiente personalizada (`worker-src 'self'`, `connect-src 'self'`) | **Requisito nuevo para doc 09** — verificado que el default bloquea el plan ingenuo | Plan B fake-worker + factories bundleadas (§6.1) |
